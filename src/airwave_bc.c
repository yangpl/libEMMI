...
void airwave_bc_update_H(emf_t *emf, float ***H3, float ***H1, float ***H2)
{
  ...
  for(i2=0; i2<emf->n2fft; i2++){
	...
	emf_kxky[i1+emf->n1fft*i2] = H3[emf->nbe][i2][i1] + I*0.; 
      else
  ...
  for(i3=0; i3<emf->rd3; i3++){
	...
	H1[emf->nbe-1-i3][i2][i1] = creal(emf_kxky[i1+emf->n1fft*i2]/(emf->n1fft*emf->n2fft));
      }
    }    
  }
  ...
  for(i3=0; i3<emf->rd3; i3++){
    ...
    for(i2=0; i2<emf->n2pad; i2++){
      for(i1=0; i1<emf->n1pad; i1++){
	H2[emf->nbe-1-i3][i2][i1] = creal(emf_kxky[i1+emf->n1fft*i2]/(emf->n1fft*emf->n2fft));
      }
    }
  }
...
void airwave_bc_update_E(emf_t *emf, float ***E1, float ***E2)
{
  ...
  for(i2=0; i2<emf->n2fft; i2++){
    for(i1=0; i1<emf->n1fft; i1++){
      if(i1<emf->n1pad && i2<emf->n2pad)
	emf_kxky[i1+emf->n1fft*i2] = E1[emf->nbe][i2][i1] + I*0.; 
      else
	emf_kxky[i1+emf->n1fft*i2] = 0. + I*0.;
    }
  }
  ...
  for(i3=0; i3<emf->rd3-1; i3++){
    ...
    for(i2=0; i2<emf->n2pad; i2++){
      for(i1=0; i1<emf->n1pad; i1++){
	E1[emf->nbe-1-i3][i2][i1] = creal(emf_kxky[i1+emf->n1fft*i2]/(emf->n1fft*emf->n2fft));
      }
    }
  }
  ...
  for(i2=0; i2<emf->n2fft; i2++){
    for(i1=0; i1<emf->n1fft; i1++){
      if(i1<emf->n1pad && i2<emf->n2pad)
	emf_kxky[i1+emf->n1fft*i2] = E2[emf->nbe][i2][i1] + I*0.; 
      else
	emf_kxky[i1+emf->n1fft*i2] = 0. + I*0.;
    }
  }
  ...
  for(i3=0; i3<emf->rd3-1; i3++){
    ...
    for(i2=0; i2<emf->n2pad; i2++){
      for(i1=0; i1<emf->n1pad; i1++){
	E2[emf->nbe-1-i3][i2][i1] = creal(emf_kxky[i1+emf->n1fft*i2]/(emf->n1fft*emf->n2fft));
      }
    }
  }
}
